...
消费者组创建好之后，我们可以给每个「[消费者组](https://www.zhihu.com/search?q=消费者组&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra={"sourceType"%3A"answer"%2C"sourceId"%3A1931265868})」下面挂一个「消费者」，让它们分别处理同一批数据。
